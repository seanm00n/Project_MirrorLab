...
UCLASS(config=Game)
class ATP_SideScrollerCharacter : public ACharacter ,public IInteractionInterface
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category = Projectile)
		TSubclassOf<class APortalEXProjectile> ProjectileClass;
